...
function initKakaoMap() {
    ...
    const options = {
        center: new kakao.maps.LatLng(37.5615, 126.8253),
        level: 3
    };
    ...
    // 마커 표시
    const markerPosition = new kakao.maps.LatLng(37.5615, 126.8253);
    ...
    // 인포윈도우 표시
    const iwContent = '<div style="padding:5px;">보타닉파크 웨딩</div>';
...
function openNaverMap() {
    const address = '서울특별시 강서구 마곡중앙로 161-8';
